...
(function () {
    ...
    angular
        .module('myApp')
        .controller('Task8EMPController', Task8EMPController);

    /** @ngInject */
    function Task8EMPController($rootScope,$scope,$location,$cookies,$timeout,$http) {
      ...
      /*  if(isOdd(vm.userSeq)){
        ...
        vm.next=function () {
            ...
            var task={role:"emp",taskNum:"8",time:usedTime,userName:vm.username,answer1:vm.voltage,answer2:vm.frequency};
            UpdateEvaluationTask(task).then(function (result) {
                console.log(result);
            });
