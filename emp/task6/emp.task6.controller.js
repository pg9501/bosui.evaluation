...
(function () {
    ...
    angular
        .module('myApp')
        .controller('Task6EMPController', Task6EMPController);

    /** @ngInject */
    function Task6EMPController($rootScope,$scope,$location,$cookies,$timeout,$http) {
      ...
      /*  $scope.$on('$locationChangeStart', function (event, newUrl, oldUrl) {
        ...
        vm.next=function () {
            ...
            var task={role:"emp",taskNum:"6",time:usedTime,userName:vm.username};
          /*  UpdateEvaluationTask(task).then(function (result) {
                console.log(result);

            });*/
            $location.path('/emp/task7');
        };
