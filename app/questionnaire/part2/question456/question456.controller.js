...
(function () {
    ...
    angular
        .module('myApp')
        .controller('QuestionnairePart2Question456Controller', QuestionnairePart2Question456Controller);

    /** @ngInject */
    function QuestionnairePart2Question456Controller($rootScope,$location,$cookies,$timeout,$http) {
        ...
        vm.answer3="";
        vm.next=function () {
            var question1={userName:vm.username, type:"part2",questionNum:"4",answer:vm.answer1};
            var question2={userName:vm.username, type:"part2",questionNum:"5",answer:vm.answer2};
            var question3={userName:vm.username, type:"part2",questionNum:"6",answer:vm.answer3};
           ...
           $location.path('/questionnaire/part2/question789');
        }
