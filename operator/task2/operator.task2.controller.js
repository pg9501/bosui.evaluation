...
(function () {
    ...
    angular
        .module('myApp')
        .controller('OperatorTask2Controller', OperatorTask2Controller);

    /** @ngInject */
    function OperatorTask2Controller($rootScope,$scope,$location,$cookies,$timeout,$http) {
       ...
       // console.log("vm.userSeq is "+vm.userSeq);
        ...
        vm.finished = function(){
            ...
            if(!vm.isFinished){
                ...
                var task={role:"Operator",taskNum:"2",time:usedTime,userName:vm.username};
                UpdateEvaluationTask(task).then(function (result) {
                    console.log(result);

                });
                $location.path('/operator/task3');
            }
