...
(function () {
    ...
    angular
        .module('myApp')
        .controller('QuestionnairePart1Question131415Controller', QuestionnairePart1Question131415Controller);

    /** @ngInject */
    function QuestionnairePart1Question131415Controller($rootScope,$location,$cookies,$timeout,$http) {
