...
(function () {
    ...
    angular
        .module('myApp')
        .controller('QuestionnairePart1Question161718Controller', QuestionnairePart1Question161718Controller);

    /** @ngInject */
    function QuestionnairePart1Question161718Controller($rootScope,$location,$cookies,$timeout,$http) {
