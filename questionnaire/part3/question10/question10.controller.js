...
(function () {
    ...
    angular
        .module('myApp')
        .controller('QuestionnairePart3Question10Controller', QuestionnairePart3Question10Controller);

    /** @ngInject */
    function QuestionnairePart3Question10Controller($rootScope,$location,$cookies,$timeout,$http) {
        ...
        vm.next=function () {
            ...
            var question1={userName:vm.username, type:"part3",questionNum:"10",answer:vm.answer1};
