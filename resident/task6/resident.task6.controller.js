...
(function () {
    ...
    angular
        .module('myApp')
        .controller('ResidentTask6Controller', ResidentTask6Controller);

    /** @ngInject */
    function ResidentTask6Controller($rootScope,$scope,$location,$cookies,$timeout,$http) {
       ...
       /* $scope.$on('$locationChangeStart', function (event, newUrl, oldUrl) {
        ...
        vm.finished = function(){
           ...
           /* if(!vm.isFinished) {
                ...
                var task={role:"Resident",taskNum:"6",time:usedTime,userName:vm.username};
                UpdateEvaluationTask(task).then(function (result) {
                    console.log(result);

                });
                $location.path('/resident/task7');
            }*/
        };
        vm.next=function () {
            vm.isFinished=true;
